...
\begin{abstract}
    Această lucrare prezintă o analiză experimentală a performanței algoritmilor de sortare, comparând soluții clasice precum Bubble Sort, Insertion Sort, Quick Sort și Merge Sort cu implementarea de referință din biblioteca standard C++, std::sort.
